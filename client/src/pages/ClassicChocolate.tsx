...
const sizeOptions: Option[] = [
  { id: "small", label: "Small", sublabel: "5 pcs - $8", value: "small", price: 8 },
  { id: "medium", label: "Medium", sublabel: "10 pcs - $15", value: "medium", price: 15 },
  { id: "large", label: "Large", sublabel: "15 pcs - $22", value: "large", price: 22 }
];
...
type ChocolateSize = "small" | "medium" | "large";
type ChocolateType = "milk" | "dark";

const priceMap: Record<ChocolateSize, Record<ChocolateType, number>> = {
  small: { milk: 8, dark: 10 },
  medium: { milk: 15, dark: 18 },
  large: { milk: 22, dark: 25 }
};

const ClassicChocolate = () => {
  const [selectedSize, setSelectedSize] = useState<ChocolateSize>("small");
  const [selectedType, setSelectedType] = useState<ChocolateType>("milk");
  ...
  const { data: reviews = [] } = useQuery({
    queryKey: [`product-reviews-classic`],
    queryFn: () => getProductReviews("classic"),
  ...
  const handleAddToCart = () => {
    addToCart({
      ...
      size: selectedSize === "small" ? "Small (5 pcs)" : selectedSize === "medium" ? "Medium (10 pcs)" : "Large (15 pcs)",
    ...
    toast({
      title: "Added to cart",
      description: `${quantity} ${selectedSize} ${selectedType} Classic Dubai Chocolate added to your cart.`,
      duration: 1000,
    });
  };
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            <img 
              src="https://images.unsplash.com/photo-1582005450386-de4293070382?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
              alt="Classic Dubai Chocolate" 
          ...
          >
            ...
            >
              Our timeless collection of handcrafted chocolates, made with the finest cocoa beans. Each piece is carefully crafted to deliver a rich and smooth taste experience that melts in your mouth.
            </motion.p>
            ...
            >
              <OptionSelector 
                ...
                onChange={(value) => setSelectedSize(value as ChocolateSize)}
              />
            </motion.div>
            ...
            >
              <OptionSelector 
                ...
                onChange={(value) => setSelectedType(value as ChocolateType)}
              />
            </motion.div>
        ...
        {/* Review System */}
        <ReviewSystem productId="classic" />
...
export default ClassicChocolate;